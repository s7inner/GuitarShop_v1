<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="favviewguitars.aspx.cs" Inherits="ElibraryManagement.favviewguitars" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <center>
                    <h3>Корзина добавлених товарів</h3>
                </center>
                <div class="row">
                ...
                <br />
                <div class="row">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDB2ConnectionString %>" SelectCommand="SELECT * FROM [guitar_fav_master_tbl] WHERE ([sessionUsername] LIKE '%' + @sessionUsername + '%')">
                        <SelectParameters>
                            <asp:SessionParameter Name="sessionUsername" SessionField="fullname" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <div class="col">
        ...
        <div class="row">
                    ...
                    <div class="col-3">
                        <asp:Button ID="Button3" class="btn btn-lg btn-block btn-success" runat="server" Text="Замовити"  OnClick="Button1_Click" Font-Size="Medium"  />
